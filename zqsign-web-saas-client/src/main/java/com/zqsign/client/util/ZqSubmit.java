...
public class ZqSubmit {
	 ...
	 */
   public static String buildRequest(Map<String, String>  params,String netURL,String privateKey) throws Exception {
	   //待请求参数数组
	   //私钥
	   String wsFormInfo = RsaSign.createLinkString(params);
	   //生成签名结果
	   String wsSignVal=RsaSign.sign(wsFormInfo,privateKey);
