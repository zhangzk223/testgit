...
public class LivessTest {
	...
	String url="http://192.168.1.176:8080/zqsign-web-identify";
	
	@Test
	public void live() throws Exception{
		HashMap<String, String> hashMap = new HashMap<>();
		hashMap.put("zqid", zqid);
		hashMap.put("order_no", System.nanoTime()+"");
		hashMap.put("return_url", "http://127.0.0.1:8080/zqsign-web-identity/");
		hashMap.put("notify_url", "http://127.0.0.1:8080/zqsign-web-identity/");
		String s = ZqSubmit.buildRequest(hashMap, url+"/h5fca", privateKey);
