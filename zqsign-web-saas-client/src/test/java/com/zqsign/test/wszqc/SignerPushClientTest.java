...
//	String url="http://192.168.1.151:8080/zqsign-web-saas-wszqc";
	...
	String url="http://192.168.1.152:8080/zqsign-web-saas-wszqc/";
	/**
	 * 个人用户注册。
	 * @throws IOException 
	 */
	...
	public void userReg() throws IOException{
		...
		System.out.println("usercode:"+usercode+"==result:"+s);//0867d94b-204c-4bfe-bbb6-be43d20ae959
	}
	
	
	@Test
	public void userChange() throws IOException{
		String usercode = "f2339363-972e-428b-a65e-c199e6afa0a4";String idcard ="410185198504095018";String mobile="13676943456";
		HashMap<String, String> hashMap = new HashMap<>();
	...
	public void entpReg() throws IOException{
		...
		System.out.println("usercode:"+usercode+"-result:"+s);
	}
	@Test
	public void entpChange() throws IOException{
		String usercode = "7ed364dc-0d21-41ed-9a93-91272a6884e6";String certificate ="410184095018";String mobile="13676943455";
		HashMap<String, String> hashMap = new HashMap<>();
		hashMap.put("zqid", zqid);
		hashMap.put("name", "zhangsan22");
		hashMap.put("contact", "张三");
		hashMap.put("address", "河南省郑州市");
		hashMap.put("mobile", mobile);
		hashMap.put("user_code", usercode);
	...
	public void signatureChange() throws IOException{
		...
		String signature = Base64.encode(byteArray);
