...
public class PersonUpdate {
	...
	public static void main(String[] args) throws IOException {
		String user_code = "6fc171c4-eaf9-473b-9134-89df6bc255c9";

		String private_key = ZqsignManage.PRIVATE_KEY;
		String request_url = ZqsignManage.REQUEST_URL + "personUpdate";
		...
		personRegRequest.setName("佘宏利");// 平台方用户姓名
		personRegRequest.setId_card_no("411522199112031535");// 身份证号
		personRegRequest.setMobile("15201257519");// 联系电话（手机号码）
		// 签名
