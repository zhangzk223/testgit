...
/**
 * 
 * @ClassName: H5_SignWriteNoCode   
 * @Description: 模拟手机端手写不验证签署，将请求结果放在.html文件中进行请求，就能显示当前签署方式的h5页面。
 * @date: 2017年6月7日 下午2:22:41   
 *
 */
public class H5_SignWriteNoCode {
	...
	public static void main(String[] args) throws Exception {
		...
		showSigningRequest.setSign_type(ZqsignManage.SignType.WRITTEN);//手写不验证签署
