...
/**
 * 
 * @ClassName: H5_SignWriteCode   
 * @Description: 模拟手机端手写验证签署，将请求结果放在.html文件中进行请求，就能显示当前签署方式的h5页面。
 * @date: 2017年6月7日 下午2:22:32   
 *
 */
public class H5_SignWriteCode {
	...
	public static void main(String[] args) throws Exception {
		...
		showSigningRequest.setSign_type(ZqsignManage.SignType.WRITTENCODE);//手写验证签署
